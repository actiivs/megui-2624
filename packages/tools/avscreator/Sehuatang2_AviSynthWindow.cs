...
{
    class Sehuatang2_AviSynthWindow : ThzBTCom_AviSynthWindow
    {
        public Sehuatang2_AviSynthWindow(MainForm mainForm) : base(mainForm)
        {
        }

        public Sehuatang2_AviSynthWindow(MainForm mainForm, string videoInput) : base(mainForm, videoInput)
        {
        }

        public Sehuatang2_AviSynthWindow(MainForm mainForm, string videoInput, string indexFile) : base(mainForm, videoInput, indexFile)
        {
        }
        ...
        protected override void showScript(bool bForce)
        {
            ...
            if (file != null && videoOutput != null)
            {
                ...
                var left = string.Format("left = last.LanczosResize(1280,720){0}res = xlogo(left, \"G:\\Logo\\77xx_x_1146_y_666_2.bmp\", X=1146, Y=666, alpha=20){0}return res", Environment.NewLine);
    ...
    public class Sehuatang2_AviSynthWindowTool : MeGUI.core.plugins.interfaces.ITool
    {
        ...
        public string Name
        {
            get { return "Sehuatang2 AVS Script Creator"; }
        }
        ...
        {
            get { return new Shortcut[] { Shortcut.Alt6 }; }
        }
        ...
        public string ID
        {
            get { return "Sehuatang2_AvsCreator"; }
        }
