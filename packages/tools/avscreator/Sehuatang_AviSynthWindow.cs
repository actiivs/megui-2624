...
{
	class Sehuatang_AviSynthWindow : ThzBTCom_AviSynthWindow
	{
		public Sehuatang_AviSynthWindow(MainForm mainForm) : base(mainForm)
		{
		}

		public Sehuatang_AviSynthWindow(MainForm mainForm, string videoInput) : base(mainForm, videoInput)
		{
		}

		public Sehuatang_AviSynthWindow(MainForm mainForm, string videoInput, string indexFile) : base(mainForm, videoInput, indexFile)
		{
		}
		...
		protected override void showScript(bool bForce)
		{
			...
			if (file != null && videoOutput != null)
			{
				...
				var left = string.Format("left = last.LanczosResize(1280,720){0}res = xlogo(left, \"G:\\Logo\\77xx_x_1162_y_666_2.bmp\", X=1162, Y=666, alpha=20){0}return res", Environment.NewLine);
	...
	public class Sehuatang_AviSynthWindowTool : MeGUI.core.plugins.interfaces.ITool
	{
		...
		public string Name
		{
			get { return "Sehuatang AVS Script Creator"; }
		}

		public void Run(MainForm info)
		{
			info.ClosePlayer();
			var asw = new Sehuatang_AviSynthWindow(info);
		...
		{
			get { return new Shortcut[] { Shortcut.Alt4 }; }
		}
		...
		public string ID
		{
			get { return "Sehuatang_AvsCreator"; }
		}
